...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden;">
  ...
  <tr><td style="background:#2d1b4e;padding:26px 32px 24px;text-align:center;">
    ...
    <a href="${site}/shop" style="text-decoration:none;">
      ...
      <!-- "Charmz" ships as a pre-rendered Caveat wordmark: webmail clients
           (Gmail, Outlook, PrivateEmail…) strip web fonts, so live text can
           never carry the brand script. The PNG is generated by npm run icons
           from the same font as the site wordmark. -->
